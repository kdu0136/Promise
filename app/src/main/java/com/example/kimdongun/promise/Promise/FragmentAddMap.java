...
public class FragmentAddMap extends Fragment implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public FragmentAddMap() {
        // Required empty public constructor
    }

    @Override
    public String toString() {
        return "FragmentAddMap";
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Permission.permissionLocation(getActivity());
        ...
        if(TYPE_OF_MAP == ARRIVE){
            ...
            selectPlace.setItem(((AddActivity)getActivity()).getArrivePlace());
        }else if(TYPE_OF_MAP == START){
            button_select.setVisibility(View.INVISIBLE);
            button_select2.setVisibility(View.VISIBLE);
            selectPlace.setItem(((AddActivity)getActivity()).getStartPlace());
        }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.button_select: //장소 선택 버튼
                ((AddActivity)getActivity()).setArrivePlace(selectPlace);
                ((AddActivity)getActivity()).switchFragment("FragmentAddMain");
                break;

            case R.id.button_select2: //장소 선택 버튼
                ((AddActivity)getActivity()).setStartPlace(selectPlace);
                ((AddActivity)getActivity()).switchFragment("FragmentAddMain");
                break;
        }
    }
