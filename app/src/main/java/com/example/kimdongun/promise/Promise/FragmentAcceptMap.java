...
public class FragmentAcceptMap extends Fragment implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public FragmentAcceptMap() {
        // Required empty public constructor
    }

    @Override
    public String toString() {
        return "FragmentAcceptMap";
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if(TYPE_OF_MAP == ARRIVE){
            ...
            selectPlace.setItem(((AcceptPromiseActivity)getActivity()).getArrivePlace());
            LinearLayout layout_searchView = (LinearLayout)view.findViewById(R.id.layout_searchView);

            layout_searchView.setLayoutParams(new LinearLayout.LayoutParams(
            ...
            selectPlace.setItem(((AcceptPromiseActivity)getActivity()).getStartPlace());
        }
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                searchText = newText;
                //if(!setQuery && searchText != "" && searchText.length() > 0)
                //    searchPlace2();
                return false;
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.button_select: //장소 선택 버튼
                ((AcceptPromiseActivity)getActivity()).setArrivePlace(selectPlace);
                ((AcceptPromiseActivity)getActivity()).switchFragment("FragmentAcceptMain");
                break;

            case R.id.button_select2: //장소 선택 버튼
                ((AcceptPromiseActivity)getActivity()).setStartPlace(selectPlace);
                ((AcceptPromiseActivity)getActivity()).switchFragment("FragmentAcceptMain");
                break;
        }
    }
